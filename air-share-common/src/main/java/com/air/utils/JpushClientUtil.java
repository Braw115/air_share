...
public class JpushClientUtil {
	...
	private final static String appKey = "83af102650893b1a152fef42";

	private final static String masterSecret = "3764484b3bd104cf36a378ae";
	 ...
	 * @return 0推送失败，1推送成功
	 */
	public static int sendToRegistrationId(String alias, String notification_title, String msg_title,
			String msg_content, String extrasparam) {
		int result = 0;
		try {
			PushPayload pushPayload = JpushClientUtil.buildPushObject_all_registrationId_alertWithTitle(alias,
	...
	private static PushPayload buildPushObject_all_registrationId_alertWithTitle(String alias,
     ...
     * @return PushPayload
     */
    public static PushPayload buildPushObject_android_ios_alias_alert(String alias, String alert, String title, HashMap extra, long created){
        return PushPayload.newBuilder()
                ...
                .setMessage(Message.newBuilder()
                		.setMsgContent(alert)
                		.setTitle(title)
                		.addExtra("created", 1531742286000l)
                		.addExtras(extra)
                		.build())
                .setOptions(Options.newBuilder()
     ...
     * @return PushResult
     */
    public static PushResult push(String alias,String alert, String title, HashMap extras, long created){
        ClientConfig clientConfig = ClientConfig.getInstance();
        JPushClient jpushClient = new JPushClient(masterSecret, appKey, null, clientConfig);
        PushPayload payload = buildPushObject_android_ios_alias_alert(alias,alert,title, extras, created);
        try {
